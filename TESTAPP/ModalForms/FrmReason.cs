...
namespace SHOPLITE.ModalForms
{
    public partial class FrmReason : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Please Enter Reason Code.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
            if (String.IsNullOrEmpty(txtReasonName.Text))
            {
                MessageBox.Show("Please Enter Reason Name.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
            if (repository.GetReason(txtReasonCode.Text) == null)
            {
                ...
                {
                    MessageBox.Show("Reason Created Successfully", "Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
            ...
            else
            {
                ...
                {
                    MessageBox.Show("Reason Updated Successfully", "Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    txtReasonCode_Leave(sender, e);
                    return;
                }
                else

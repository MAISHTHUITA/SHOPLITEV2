...
namespace SHOPLITE.ModalForms
{
    public partial class frmTillManagement : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Please Enter Till Code.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                txtTillcode.Focus();
                return;
            }
            if (string.IsNullOrEmpty(txtMachineName.Text))
            {
                MessageBox.Show("Please Enter Machine Name.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            ...
            try
            {
                ...
                {
                    //this is update
                    if ((MessageBox.Show("Till Already Exist. Do you Want To Update?", "Error", MessageBoxButtons.YesNo, MessageBoxIcon.Question)) == DialogResult.Yes)
                    {
                        if (till.EditTill(till))
                        {
                            MessageBox.Show("Till Updated Successfully", "Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
                        }
                        else
                        {
                            MessageBox.Show("Till Update Failed", "Failure", MessageBoxButtons.OK, MessageBoxIcon.Error);
                            txtTillcode.Focus();
                        }
                    }
                    return;
                ...
                {
                    MessageBox.Show("Till Saved Successfully", "Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    txtTillcode_Leave(sender, e);
                }
                else
                {
                    MessageBox.Show("Till Saving UnSuccessful", "Failure", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    txtTillcode.Focus();
                }
            }
            catch (Exception exe)
            {
                ...
                MessageBox.Show(exe.Message, "Failure", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }

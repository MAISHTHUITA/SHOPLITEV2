...
namespace SHOPLITE.ModalForms
{
    public partial class frmViewGrn : Form
    {
        ...
        private void BtnPrint_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Please Enter From Supplier Code.");
                return;
            }
            if (String.IsNullOrEmpty(txtToSupp.Text))
            {
                MessageBox.Show("Please Enter To Supplier Code.");
                return;
            }
            if (String.IsNullOrEmpty(txtFromGrn.Text))
            {
                MessageBox.Show("Please Enter From Grn.");
                return;
            }
            if (String.IsNullOrEmpty(txtToGrn.Text))
            {
                MessageBox.Show("Please Enter To Grn.");
                return;
            }
            if (rbSum.Checked)
            {
                ...
                {
                    MessageBox.Show("No Records To display.", "No Records");
                }
            }

    ...
    public partial class frmMiscIssue : Form
    {
        ...
        private void btngdadd_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    if (MessageBox.Show("Are your sure you want to issue quantity more than quantity available?", "Negative Issue?", MessageBoxButtons.OKCancel, MessageBoxIcon.Question) == DialogResult.Cancel)
                    {
                        return;
                    }
                }
                ...
                try
                {
                    ...
                    using (SqlConnection con = new SqlConnection(DbCon.connection))
                    {
                        ...
                        try
                        {
                            ...
                            MessageBox.Show("Issue Saved Successfully.", "Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
                            /// if  we reach here, no error has occurred;
                            MessageBox.Show("The Miscellenous Issue Note Number is " + returned);

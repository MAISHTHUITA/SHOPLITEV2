...
namespace SHOPLITE.ModalForms
{
    public partial class frmViewInvoices : Form
    {
        ...
        private void btnView_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Please enter From Customer Code.");
                txtCustCode.Focus();
                return;
            }
            ...
            if (String.IsNullOrEmpty(txtCustCode.Text))
            {
                MessageBox.Show("Please enter To Customer Code.");
                txtCustCode.Focus();
                return;
            }
        ...
        private void txtCustCode_Leave(object sender, EventArgs e)
        {
            ...
            if (customer == null)
            {
                MessageBox.Show("Please enter Valid From Customer Code.");
                txtCustCode.Focus();
                txtCustName.Text = "";
                return;
            }
        ...
        private void txtToCustCd_Leave(object sender, EventArgs e)
        {
            ...
            if (customer == null)
            {
                MessageBox.Show("Please enter Valid To Customer Code.");
                txtToCustCd.Focus();
                txtToCustNm.Text = "";
                return;
            }

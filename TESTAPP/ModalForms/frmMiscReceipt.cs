...
namespace SHOPLITE.ModalForms
{
    public partial class frmMiscReceipt : Form
    {
                ...
                try
                {
                    ...
                    using (SqlConnection con = new SqlConnection(DbCon.connection))
                    {
                        ...
                        try
                        {
                            ...
                            MessageBox.Show("The Miscellenous Receipt Note Number is " + returned);
        ...
        private void txtSn_Leave(object sender, EventArgs e)
        {
            ...
            if (grnMaster == null)
            {
                MessageBox.Show("Invalid Miscellenous Issue Number.");
                txtSn.Text = "";
                txtSn.Focus();
            }
            else
        ...
        private void txtReason_Leave(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Please Enter Reason Code.");
                txtReason.Focus();
            }
        }

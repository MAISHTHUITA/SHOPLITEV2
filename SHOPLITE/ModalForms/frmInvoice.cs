    ...
    public partial class frmInvoice : Form
    {
        ...
        private void txtgdProdNm_Leave(object sender, EventArgs e)
        {
            if (!String.IsNullOrEmpty(txtgdProdNm.Text))
            {
                ...
                if (product != null)
                {
                    ...
                    txtgdVatcd.Text = product.VatPercentage.ToString(); txtgdCp.Text = product.Cp.ToString("0.00"); txtgdSp.Text = product.WholesaleSp.ToString("0.00");
        ...
        private void btngdadd_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    if (RJMessageBox.Show("Are your sure you want to issue quantity more than quantity available?", "Negative Sale", MessageBoxButtons.OKCancel, MessageBoxIcon.Question) == DialogResult.Cancel)
                    {
                        return;
                    }
                }
                ...
                try
                {
                    ...
                    using (SqlConnection con = new SqlConnection(DbCon.connection))
                    {
                        ...
                        try
                        {
                            ...
                            RJMessageBox.Show("Invoice Saved Successfully.", "Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
                            /// if  we reach here, no error has occurred;
                            RJMessageBox.Show("The Invoice Number is " + returned);
        ...
        private void txtSn_Leave(object sender, EventArgs e)
        {
            ...
            if (grnMaster == null)
            {
                RJMessageBox.Show("Invalid Invoice Number.");
                txtSn.Text = "";
                txtSn.Focus();
            }
            else

...
namespace SHOPLITE.ModalForms
{
    public partial class frmUsers : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                RJMessageBox.Show("Password do not match.", "Confirm Password", MessageBoxButtons.OK, MessageBoxIcon.Information);
                txtConfirmPwd.Focus();
                return;
            }
            Group group = new Group();
            ...
            {
                RJMessageBox.Show("Please Enter Valid Group.", "Invalid Group", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
            ...
            if (user.GetUser(txtUsername.Text) != null)
            {
                ...
                {
                    RJMessageBox.Show("User updated Successfully.", "Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    btnCancel_Click(sender, e);
                }
                else
                {
                    RJMessageBox.Show("User update Failed.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
            }
            else
            {
                ...
                {
                    RJMessageBox.Show("User Created Successfully.", "Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    btnCancel_Click(sender, e);
                }
                else
                {
                    RJMessageBox.Show("User Creation Failed.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
            }

...
namespace SHOPLITE.ModalForms
{
    public partial class frmSalesReport : Form
    {
        ...
        private void btnView_Click(object sender, EventArgs e)
        {
            ...
            {
                RJMessageBox.Show("Please enter From User code", "info", MessageBoxButtons.OK);
                txtFromUser.Focus();
                return;
            }
            if (String.IsNullOrEmpty(TxtToUser.Text))
            {
                RJMessageBox.Show("Please enter to User code", "info", MessageBoxButtons.OK);
                TxtToUser.Focus();
                return;
            }
            Sale daily = new Sale();
            ...
            {
                RJMessageBox.Show("No Records To Display", "ShopLite Notificatios", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
        }
        ...
        private void txtFromUser_Leave(object sender, EventArgs e)
        {
            if (!String.IsNullOrEmpty(txtFromUser.Text))
            {
                ...
                {
                    RJMessageBox.Show("Invalid Username Code", "Info", MessageBoxButtons.OK);
                    txtFromUser.Text = "";
                    txtFromUser.Focus();
                }
            }

...
namespace SHOPLITE.ModalForms
{
    public partial class frmUnitMaster : Form
    {
        ...
        private void btnEditUnit_Click(object sender, EventArgs e)
        {
            ...
            {
                RJMessageBox.Show("Please enter unit Code.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
            UnitRepository repository = new UnitRepository();
            ...
            {
                RJMessageBox.Show("Invalid unit Code.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }

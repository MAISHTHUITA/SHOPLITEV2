...
namespace SHOPLITE.ModalForms
{
    public partial class frmVatMaster : Form
    {
        ...
        private void btnEditVat_Click(object sender, EventArgs e)
        {
            ...
            {
                RJMessageBox.Show("Please Enter Vat Code", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
            Vat vat = new Vat();
            ...
            if (vat != null)
            {
                ...
                RJMessageBox.Show("Vat Code does not exist in the database", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
        }
